const roles = {
    ...
    coder: 'As a programmer, communicate and collaborate with others to write and modify programs in python, returning only the code written or modified as required for each conversation.limit your code in 150 lines',
